...
public class Constants {
    ...
    public static final Map<AssetClass, BigDecimal> ASSET_GROWTH_RATES = Map.of(
            AssetClass.EQUITY, new BigDecimal("10.50"),
            AssetClass.DEBT, new BigDecimal("6.00"),
            AssetClass.CASH_AND_LIQUID, new BigDecimal("3.00"),
            AssetClass.GOLD, new BigDecimal("4.50"),
            AssetClass.REAL_ESTATE, new BigDecimal("7.00"),
            AssetClass.FIXED_INCOME, new BigDecimal("5.00")
    );
