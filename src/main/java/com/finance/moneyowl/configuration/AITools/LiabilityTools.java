...
public class LiabilityTools {
    ...
    public Function<LiabilityRequest, LiabilityResponse> getUserLiabilities() {
        return liabilityRequest -> {
            log.info("Start LiabilityTools :: getUserLiabilities - {}", liabilityRequest.userId);
            List<LiabilityDTO> data = userService.getAllUserLiabilities(liabilityRequest.userId);
